...
def derive():
    ...
    H_lambda = lambdify([tuple([m1, l1, r1, I1, m2, l2, r2,
                        I2, g]+[q1, q2, q1dot, q2dot])], H, 'numpy', cse=True)
    F_lambda = lambdify([tuple([m1, l1, r1, I1, m2, l2, r2, I2, g] +
                        [q1, q2, q1dot, q2dot]+[a1, a2])], F, 'numpy', cse=True)
    D_lambda = lambdify([tuple([m1, l1, r1, I1, m2, l2, r2, I2, g] +
                        [q1, q2, q1dot, q2dot]+[a1, a2])], (D_s, D_a), 'numpy', cse=True)
