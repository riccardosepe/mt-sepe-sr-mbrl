...
class reacher(BaseEnv):
    def __init__(self, mle):
        ...
        super(reacher, self).__init__(name="reacher",
                                      ...
                                      obs_size=6,
                                      action_size=2,
                                      inertials=[m1, self.l1, self.r1,
                                                 I1, m2, self.l2, self.r2, I2, g],
                                      dt=0.02,
    ...
    def get_reward(self):
        upright = (
            np.array([np.cos(self.state[0]), np.cos(self.state[0]+self.state[1])])+1)/2
    ...
    def draw(self):
        ...
        link1_points = rect_points(
            link1_center, self.l1, height, np.pi/2-self.state[0], scaling, offset)
        ...
        link2_points = rect_points(
            link2_center, self.l2, height, np.pi/2-self.state[0]-self.state[1], scaling, offset)

        pygame.draw.polygon(self.screen, (72, 209, 204),
                            link1_points)  # medium turquoise
        pygame.draw.circle(self.screen, (255, 69, 0), joint1,
        ...
        pygame.draw.circle(self.screen, 'slateblue1',
                           end_point, scaling*height/1.8)  # orange red
