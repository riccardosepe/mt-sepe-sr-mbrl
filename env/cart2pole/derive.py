...
def derive():
    n = 3
    m1, m2, l2, r2, I2, m3, l3, r3, I3, g = symbols(
        'm1 m2 l2 r2 I2 m3 l3 r3 I3 g')
    ...
    H_lambda = lambdify([tuple([m1, m2, l2, r2, I2, m3, l3, r3, I3, g] +
                        [q1, q2, q3, q1dot, q2dot, q3dot])], H, 'numpy', cse=True)
    F_lambda = lambdify([tuple([m1, m2, l2, r2, I2, m3, l3, r3, I3, g] +
                        [q1, q2, q3, q1dot, q2dot, q3dot]+[a1])], F, 'numpy', cse=True)
    D_lambda = lambdify([tuple([m1, m2, l2, r2, I2, m3, l3, r3, I3, g] +
                        [q1, q2, q3, q1dot, q2dot, q3dot]+[a1])], (D_s, D_a), 'numpy', cse=True)
