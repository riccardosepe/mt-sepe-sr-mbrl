...
def derive():
    n = 3
    m1, l1, r1, I1, m2, l2, r2, I2, m3, l3, r3, I3, g = symbols(
        'm1 l1 r1 I1 m2 l2 r2 I2 m3 l3 r3 I3 g')
    ...
    T1 = 0.5*m1*((r1*cos(q1)*q1dot)**2 + (-r1*sin(q1)*q1dot)
                 ** 2) + 0.5*I1*(q1dot**2)
    T2 = 0.5*m2*((l1*cos(q1)*q1dot+r2*cos(q1+q2)*(q1dot+q2dot))**2 + (-l1*sin(q1)
                 * q1dot-r2*sin(q1+q2)*(q1dot+q2dot))**2) + 0.5*I2*((q1dot+q2dot)**2)
    ...
    V = m1*g*r1*cos(q1)+m2*g*(l1*cos(q1)+r2*cos(q1+q2))+m3*g * \
        (l1*cos(q1)+l2*cos(q1+q2)+r3*cos(q1+q2+q3))
    ...
    H_lambda = lambdify([tuple([m1, l1, r1, I1, m2, l2, r2, I2, m3, l3,
                        r3, I3, g]+[q1, q2, q3, q1dot, q2dot, q3dot])], H, 'numpy', cse=True)
    F_lambda = lambdify([tuple([m1, l1, r1, I1, m2, l2, r2, I2, m3, l3, r3, I3, g]+[
                        q1, q2, q3, q1dot, q2dot, q3dot]+[a1, a3])], F, 'numpy', cse=True)
    D_lambda = lambdify([tuple([m1, l1, r1, I1, m2, l2, r2, I2, m3, l3, r3, I3, g]+[
                        q1, q2, q3, q1dot, q2dot, q3dot]+[a1, a3])], (D_s, D_a), 'numpy', cse=True)
...
def check():
    inertial_params = [0.1, 1.0, 0.5, 0.1/12, 0.1,
